...
consumed node fields (`arenaRead`/`towerRead`/`peelUnit`) are byte-identical between the
two structures, so every proof is byte-stable.  Prose mentions of the un-split name below
are the historical CC-11 record.
...
any ambient read. -/
def gaugeArenaAt (S : SplitNodePointSource (L := L) W E receiver K) (NL : LaurentNormalizer W)
...
theorem gaugeArenaAt_v (S : SplitNodePointSource (L := L) W E receiver K)
...
theorem gaugeArenaAt_res (S : SplitNodePointSource (L := L) W E receiver K)
    (NL : LaurentNormalizer W) {i : ℕ} (hi : StageLive r i) :
...
def arenaRead0 (S : SplitNodePointSource (L := L) W E receiver K) (j : LiveLevel r) :
...
theorem arenaRead0_apply (S : SplitNodePointSource (L := L) W E receiver K) (j : LiveLevel r)
...
def gaugeArena0At (S : SplitNodePointSource (L := L) W E receiver K) (NL : LaurentNormalizer W)
...
theorem gaugeArena0At_v (S : SplitNodePointSource (L := L) W E receiver K)
...
theorem gaugeArena0At_res (S : SplitNodePointSource (L := L) W E receiver K)
    (NL : LaurentNormalizer W) {j : ℕ} (hj : GaugeLive r j) :
...
def gaugeArenaFamily0 (S : SplitNodePointSource (L := L) W E receiver K)
...
theorem gaugeArenaFamily0_live (S : SplitNodePointSource (L := L) W E receiver K)
...
theorem gaugeArenaFamily0_junk (S : SplitNodePointSource (L := L) W E receiver K)
    (NL : LaurentNormalizer W) (hr : 1 < r) {j : ℕ} (hj : ¬ GaugeLive r j) :
...
def towerReadFamily0 (S : SplitNodePointSource (L := L) W E receiver K) :
...
theorem towerReadFamily0_live (S : SplitNodePointSource (L := L) W E receiver K)
...
theorem towerReadFamily0_junk (S : SplitNodePointSource (L := L) W E receiver K)
    {j : ℕ} (hj : ¬ GaugeLive r j) (g : GaugeLattice0 r) :
...
def peelUnitFamily (S : SplitNodePointSource (L := L) W E receiver K) : ℕ → Ktˣ :=
  S.peelUnit

/-- Anti-drift pin: the peel-unit family is the `peelUnit` source field, nothing else. -/
theorem peelUnitFamily_eq (S : SplitNodePointSource (L := L) W E receiver K) :
...
variable {Kt : Type uKt} [Field Kt] {E : Type uE} [Field E] {L : Type uL} [Field L] [Algebra Kt L]
variable {receiver : TerminalReceiver F H₀ hpin r W Kt} {K : KeyChain W}
variable (S : SplitNodePointSource (L := L) W E receiver K)
...
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArenaAt
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArenaAt_v
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArenaAt_res
#print axioms Uniformity.Density.Tower.SplitNodePointSource.arenaRead0
#print axioms Uniformity.Density.Tower.SplitNodePointSource.arenaRead0_apply
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArena0At
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArena0At_v
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArena0At_res
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArenaFamily0
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArenaFamily0_live
#print axioms Uniformity.Density.Tower.SplitNodePointSource.gaugeArenaFamily0_junk
#print axioms Uniformity.Density.Tower.SplitNodePointSource.towerReadFamily0
#print axioms Uniformity.Density.Tower.SplitNodePointSource.towerReadFamily0_live
#print axioms Uniformity.Density.Tower.SplitNodePointSource.towerReadFamily0_junk
#print axioms Uniformity.Density.Tower.SplitNodePointSource.peelUnitFamily
#print axioms Uniformity.Density.Tower.SplitNodePointSource.peelUnitFamily_eq
