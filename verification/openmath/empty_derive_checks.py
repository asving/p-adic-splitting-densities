...
Usage: python3 empty_derive_checks.py > empty_derive_checks_output.txt
"""
...
def main():
    ...
    prov["empty_derive_checks.py"] = hashlib.md5(
    ...
    fams = ["EDC-PIN", "EDC-LED", "EDC-TEL", "EDC-PAY", "EDC-PAYH", "EDC-FLOOR",
            ...
            "EDC-CPLUS", "EDC-YMON", "EDC-INV", "EDC-CONS", "EDC-SEAL", "HARNESS"]
    ...
    with open(os.path.join(HERE, "empty_derive_checks_results.json"), "w") as f:
        json.dump(out, f, indent=1, default=str)
    print("results -> empty_derive_checks_results.json")
