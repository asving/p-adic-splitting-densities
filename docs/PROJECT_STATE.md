...
| MNV01 | μ₃ chain head M3-NV0+NV1 → C132nv0/1 (SONNET) | RUNNING |
| CIFACE | the capstone interface nodes L0/DT0/W0/WIN0 (FABLE) | RUNNING |
...
| HW1 | H116B4_MAP fireable rows GR-1/2 + GR-3/3b (SONNET, reassigned likewise) | RUNNING (codex, launched 23:09) — mid-verification of its H116b4a.lean landing |
