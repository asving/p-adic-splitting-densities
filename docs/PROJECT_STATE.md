...
| R67 | the KEYSTONE: wired fields + the depth-four SplitNodePointSource/ChainRealization/RealizedInput (R5's handoff discharge; R34's two opens) → C136r4 | IN FLIGHT (Fable, ~03:35) |
