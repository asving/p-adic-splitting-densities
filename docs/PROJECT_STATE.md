...
| RB3R | re-base refine_invariants | DONE (523c8a7b) — monic/degree/top-digit conjuncts PROVED; the IsTestKey conjunct exposed as a statement-level OVERCLAIM vs EFF.GENTOW1.28 (codex-confirmed; unprovable-and-unrefutable as signed); repair = the M4 package, ~250-550 lines, A-C.23 candidate |
