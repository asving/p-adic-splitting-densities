# O9 — the order-r stratum census (CL-6 at OM order ≥ 2) — Phase-B verify brief REV 4 (Fable, 2026-07-31)
...
gap* (assume and continue); fix nothing. This is REV 4, repairing the pass-3
...
## 0-pre. Rev-4 changelog (the pass-3 finding → disposition → repair sites)
...
— O9 Phase-B rev 4. Verdict: PARTIAL — the order-r census REDUCED to
