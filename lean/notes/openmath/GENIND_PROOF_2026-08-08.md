...
\[
M_{\mathcal G}
 \ge e(N-1-H)-\Delta_{\mathcal G},                 \tag{CS-1Q.a}
\]

and

\[
\gamma\Delta_{\mathcal G}
 \le C_{\mathcal G}^{\mathrm{extra}}
   +\left(b_S-a-\frac12\right)H+O_{\mathcal G}(1).
                                                        \tag{CS-1Q.b}
\]
...
>
> \[
> \frac{u^{\mathrm{CS}}_{\mathcal G}(N)}
>      {Q^{m(N-1)}}
> \le K_{\mathcal G}N^{B_{\mathcal G}}
>       Q^{-a(N-1)-H/2+O_{\mathcal G}(1)}.          \tag{C2Q.1}
> \]
>
> Consequently its height sum has the required
> \(K N^B Q^{-(N-c)}\) form.
...
\[
\rho_{\mathcal G}
 \le Q^{-b_SH-C_{\mathcal G}^{\mathrm{extra}}
          +O_{\mathcal G}(1)}.                     \tag{C2Q.2}
\]
...
\[
\delta_{\mathrm{stage}}
 \le K_\star N^{B_\star}Q^{-\gamma M_{\mathcal G}
                              +O_{\mathcal G}(1)}.
\]
...
\[
-\gamma M_{\mathcal G}
 \le-a(N-1-H)+\gamma\Delta_{\mathcal G}.
\]
...
&\le K_\star N^{B_\star}
 Q^{-a(N-1)-(b_S-a)H
      -C_{\mathcal G}^{\mathrm{extra}}
      +\gamma\Delta_{\mathcal G}
      +O_{\mathcal G}(1)}\\
&\le K_\star N^{B_\star}
 Q^{-a(N-1)-H/2+O_{\mathcal G}(1)}.
\end{aligned}
\]
...
\[
b_SH+C_{\mathcal G}^{\mathrm{extra}}
 \ge a(N-1)+\frac H2-O_{\mathcal G,M_0}(1).
\]
...
\[
\mathfrak m=(\text{product degree},\text{window})
          \in\mathbb N_{>0}\times\mathbb N_{\ge1}.
\]
...
\begin{aligned}
\sum_{r=1}^{S}
 \left(\left\lceil\frac{rH}{S}\right\rceil-1\right)
&\ge
 \sum_{r=1}^{S}\frac{rH}{S}-O_m(1)\\
&=\frac{S+1}{2}H-O_m(1)\\
...
\[
\rho_{\mathcal G}
 \le Q^{-((S+1)/2)H-C_{\mathcal G}^{\mathrm{extra}}
          +O_m(1)}
 \le Q^{-((L+1)/2)H-C_{\mathcal G}^{\mathrm{extra}}
          +O_m(1)}.                                \tag{C2E.2}
\]
...
- In the height-domination step use
  \(b_S-a\ge(L+1)/2-a\ge1/2\).
