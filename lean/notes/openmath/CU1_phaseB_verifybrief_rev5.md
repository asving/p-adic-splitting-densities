# CU-1 (K-RUN-C composition, unit NM) — no-missing + interior adequacy + state binding — verify brief, REV 5 (Fable, 2026-08-02)

(Companion record: `CU1_phaseB_attempt_rev3.md` (unchanged at revs 4/5).
This is REVISION 5 — the ONE-CLAUSE gap-debt closure after the gap-check
of rev 4 (wave-12 record; harvested in the ledger's 2026-08-02 HARVEST
entry, `lean/notes/BRIDGE_ADJUDICATIONS_2026-07-30.md`: "CU-1
GAPS-REMAIN → r5"). The gap-check (fresh context, read only the rev-4
brief) checked the seven rev-4 repairs F-1..F-7: F-1/F-2/F-3/F-5/F-6/F-7
CLOSED, F-4 PARTIALLY CLOSED — rev 4 recorded the terminal-bullet third
site on map row 6 (and row 31 cross-records the same non-claim) but left
§2 scope note (3) reading "consumed ONLY in this remark and in §4's
canonicity remark", a map/prose contradiction NEW at rev 4 (rev 3 had
both at two sites), display class, no mathematical damage (Lemma R still
produces and identifies nothing); its breakage spot-check of the three
nearest confirmed sections (§3 base/step; §4 split; CU-1-SURJ/§8) found
no other breakage. REV 5 REPAIRS EXACTLY THAT ONE CLAUSE (disposition
table: §0-R5): §2 scope note (3) now lists all three sites, matching row
6's location column. The ONLY edits vs rev 4 anywhere are this preamble,
the new table §0-R5, that §2 scope-note clause (accounting text after
the proofs — the §§1–3 statements and proofs and §4's constructions
remain byte-identical to rev 2/3/4), and the closing lineage block. NO
new mathematics, NO new input, NO map change (rows 6 and 31 already
carried the correct three-site record at rev 4); no new gate is owed —
§7.4 carries. The rev-4 preamble follows, unchanged, as lineage record.)

(Rev-4 preamble. Companion record: `CU1_phaseB_attempt_rev3.md`
(unchanged at rev 4).
...
## 0-R5. Rev-5 changelog (gap-check residual → disposition; display only)

| Gap-check finding | disposition (repair site) | churn class |
|---|---|---|
| F-4 residual (the single GAPS-REMAIN item, display class): rev 4 recorded the terminal-bullet third site on map row 6 — and row 31 cross-records the same non-claim — but §2 scope note (3) still read "Lemma R is consumed ONLY in this remark and in §4's canonicity remark", a map/prose contradiction NEW at rev 4 (rev 3 had both map and prose at two sites); no mathematical damage (Lemma R still produces and identifies nothing) | §2 scope note (3): the parenthetical now lists all THREE sites — the remark itself, §4's canonicity remark, and the §4 split's terminal bullet (consumption of Lemma R's displayed NON-claim "Cons_f constrains no terminal field") — matching row 6's location column | location fix (one clause); map untouched (rows 6 and 31 already carried the correct record at rev 4); F-1/F-2/F-3/F-5/F-6/F-7 checked CLOSED by the same pass, nothing owed |
...
is consumed ONLY in this remark, in §4's canonicity remark, and at the §4
split's terminal bullet — where its displayed NON-claim "Cons_f constrains
no terminal field" warrants the terminal routing (row 6's third site, P2
F-4; prose matched to the map at rev 5); it produces
...
— CU-1 rev 5 complete. PROVED-UNVERIFIED (conditional composition, §5
...
consumption-accounting/display class, repaired at rev 4 (§0-R4); the
gap-check pass on rev 4 (fresh context, wave-12 record; ledger 2026-08-02
HARVEST entry) = GAPS-REMAIN with the SINGLE F-4-residual display item
(F-1/F-2/F-3/F-5/F-6/F-7 CLOSED; breakage spot-check clean), repaired
above (§0-R5) — per the ledger's 2026-08-02 CORRECTION + HARVEST entries
(`lean/notes/BRIDGE_ADJUDICATIONS_2026-07-30.md`), CU-1's status is
ZERO-CRITICAL-PASS-2 WITH GAP DEBTS until a gap-check pass accepts the
rev-5 repair; VERIFIED is NOT claimed. Primary gate SURVIVED (§7,
carried); falsifier accounting §7.4 carries (rev 5, like revs 3/4, adds
no input and no mechanism — the one clause re-displays in prose a
consumption site the map already carried).
