...
> HE7-L1 (HE7 §S4.1) carries the identical omission; per HE7's freeze it is
> repaired by HE7's own dated append — **IN-FLIGHT this wave, not yet landed
> at the time of this [r2] round** (landing sites per PE2 F-1's closing
> paragraph).
>
