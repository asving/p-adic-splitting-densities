...
/-!
**DEPRECATED — superseded by `L4_TRANSviii_a_R5_final.lean`. The two former sorries
(:71 Φ-adic development, :107 single-slot realizers) are now closed HERE TOO (proof ported
back from the _final file, 2026-07-27); this file is sorry-free but remains the deprecated
predecessor. Do not import — downstream uses the _final file.**
...
All closed (2026-07-27, ported back from `L4_TRANSviii_a_R5_final.lean`):
